    ...
    .constant('locales',
        {
            'en_US': {
                ...
                "parcel": {
                    ...
                    "view-parcels": "View Land lots",
                    "add": "Add Land lot",
                    "assign-to-customer": "Assign to customer",
                    "assign-parcel-to-customer": "Assign Land lot(s) To Customer",
                    "assign-parcel-to-customer-text": "Please select the land lots to assign to the customer",
                    "no-parcels-text": "No land lots found",
                    ...
                    "parcel-public": "Land lot is public",
                    "parcel-type": "Land lot type",
                    "parcel-type-required": "Land lot type is required.",
                    "select-parcel-type": "Select land lot type",
                    "enter-parcel-type": "Enter land lot type",
                    "any-parcel": "Any land lot",
                    "no-parcel-types-matching": "No land lot types matching '{{entitySubtype}}' were found.",
                    "parcel-type-list-empty": "No land lot types selected.",
                    "parcel-types": "Land lot types",
                    "name": "Name",
                    "name-required": "Name is required.",
                    "description": "Description",
                    "type": "Type",
                    ...
                    "details": "Details",
                    "events": "Events",
                    "add-parcel-text": "Add new land lot",
                    "parcel-details": "Land lot details",
                    "assign-parcels": "Assign land lots",
                    "assign-parcels-text": "Assign { count, select, 1 {1 land lot} other {# land lots} } to customer",
                    "delete-parcels": "Delete land lots",
                    "unassign-parcels": "Unassign land lots",
                    "unassign-parcels-action-title": "Unassign { count, select, 1 {1 land lot} other {# land lots} } from customer",
                    "assign-new-parcel": "Assign new land lot",
                    "delete-parcel-title": "Are you sure you want to delete the land lot '{{land lot Name}}'?",
                    "delete-parcel-text": "Be careful, after the confirmation the land lot and all related data will become unrecoverable.",
                    "delete-parcels-title": "Are you sure you want to delete { count, select, 1 {1 land lot} other {# land lots} }?",
                    "delete-parcels-action-title": "Delete { count, select, 1 {1 land lot} other {# land lots} }",
                    "delete-parcels-text": "Be careful, after the confirmation all selected land lots will be removed and all related data will become unrecoverable.",
                    "make-public-parcel-title": "Are you sure you want to make the land lot '{{land lotName}}' public?",
                    "make-public-parcel-text": "After the confirmation the land lot and all its data will be made public and accessible by others.",
                    "make-private-parcel-title": "Are you sure you want to make the land lot '{{land lot Name}}' private?",
                    "make-private-parcel-text": "After the confirmation the land lot and all its data will be made private and won't be accessible by others.",
                    "unassign-parcel-title": "Are you sure you want to unassign the land lot '{{land lot Name}}'?",
                    "unassign-parcel-text": "After the confirmation the land lot will be unassigned and won't be accessible by the customer.",
                    "unassign-parcel": "Unassign land lot",
                    "unassign-parcels-title": "Are you sure you want to unassign { count, select, 1 {1 land lot} other {# land lots} }?",
                    "unassign-parcels-text": "After the confirmation all selected land lots will be unassigned and won't be accessible by the customer.",
                    "copyId": "Copy land lot Id",
                    "idCopiedMessage": "Land lot Id has been copied to clipboard",
                    "select-parcel": "Select land lot",
                    "no-parcels-matching": "No land lots matching '{{entity}}' were found.",
                    "parcel-required": "Land lot is required",
