    ...
    .constant('locales',
        {
            'en_US': {
                ...
                "login": {
                    ...
                    "landlot": "Landlot",
                    "landlots": "Landlots",
                    "management": "Landlot management",
                    "view-landlots": "View Landlots",
                    "add": "Add Landlot",
                    "assign-to-customer": "Assign to customer",
                    "assign-landlot-to-customer": "Assign Landlot(s) To Customer",
                    "assign-landlot-to-customer-text": "Please select the landlots to assign to the customer",
                    "no-landlots-text": "No landlots found",
                    "assign-to-customer-text": "Please select the customer to assign the landlot(s)",
                    "public": "Public",
                    "assignedToCustomer": "Assigned to customer",
                    "make-public": "Make landlot public",
                    "make-private": "Make landlot private",
                    "unassign-from-customer": "Unassign from customer",
                    "delete": "Delete landlot",
                    "landlot-public": "Landlot is public",
                    "landlot-type": "Landlot type",
                    "landlot-type-required": "Landlot type is required.",
                    "select-landlot-type": "Select landlot type",
                    "enter-landlot-type": "Enter landlot type",
                    "any-landlot": "Any landlot",
                    "no-landlot-types-matching": "No landlot types matching '{{entitySubtype}}' were found.",
                    "landlot-type-list-empty": "No landlot types selected.",
                    "landlot-types": "Landlot types",
                    "name": "Name",
                    "name-required": "Name is required.",
                    "description": "Description",
                    "type": "Type",
                    ...
                    "details": "Details",
                    "events": "Events",
                    "add-landlot-text": "Add new landlot",
                    "landlot-details": "Landlot details",
                    "assign-landlots": "Assign landlots",
                    "assign-landlots-text": "Assign { count, select, 1 {1 landlot} other {# landlots} } to customer",
                    "delete-landlots": "Delete landlots",
                    "unassign-landlots": "Unassign landlots",
                    "unassign-landlots-action-title": "Unassign { count, select, 1 {1 landlot} other {# landlots} } from customer",
                    "assign-new-landlot": "Assign new landlot",
                    "delete-landlot-title": "Are you sure you want to delete the landlot '{{landlotName}}'?",
                    "delete-landlot-text": "Be careful, after the confirmation the landlot and all related data will become unrecoverable.",
                    ...
                    "delete-landlots-text": "Be careful, after the confirmation all selected landlots will be removed and all related data will become unrecoverable.",
                    "make-public-landlot-title": "Are you sure you want to make the landlot '{{landlotName}}' public?",
                    "make-public-landlot-text": "After the confirmation the landlot and all its data will be made public and accessible by others.",
                    "make-private-landlot-title": "Are you sure you want to make the landlot '{{landlotName}}' private?",
                    "make-private-landlot-text": "After the confirmation the landlot and all its data will be made private and won't be accessible by others.",
                    "unassign-landlot-title": "Are you sure you want to unassign the landlot '{{landlotName}}'?",
                    "unassign-landlot-text": "After the confirmation the landlot will be unassigned and won't be accessible by the customer.",
                    "unassign-landlot": "Unassign landlot",
                    "unassign-landlots-title": "Are you sure you want to unassign { count, select, 1 {1 landlot} other {# landlots} }?",
                    "unassign-landlots-text": "After the confirmation all selected landlots will be unassigned and won't be accessible by the customer.",
                    "copyId": "Copy landlot Id",
                    "idCopiedMessage": "Landlot Id has been copied to clipboard",
                    "select-landlot": "Select landlot",
                    "no-landlots-matching": "No landlots matching '{{entity}}' were found.",
                    "landlot-required": "Landlot is required",
                    "name-starts-with": "Landlot name starts with",
                    "totalArea": "Total area",
