    ...
    .constant('locales',
        {
            'en_US': {
                ...
                "farm": {
                    ...
                    "add": "Add Farm",
                    "assign-to-customer": "Assign to customer",
                    "assign-farm-to-customer": "Assign Farm(s) To Customer",
                    ...
                    "any-farm": "Any farm",
                    "no-farm-types-matching": "No farm types matching '{{entitySubtype}}' were found.",
                    "farm-type-list-empty": "No farm types selected.",
                    ...
                    "unassign-farms-action-title": "Unassign { count, select, 1 {1 farm} other {# farms} } from customer",
                    "assign-new-farm": "Assign new farm",
                    "delete-farm-title": "Are you sure you want to delete the farm '{{farmName}}'?",
                    "delete-farm-text": "Be careful, after the confirmation the farm and all related data will become unrecoverable.",
                    "delete-farms-title": "Are you sure you want to delete { count, select, 1 {1 farm} other {# farms} }?",
                    "delete-farms-action-title": "Delete { count, select, 1 {1 farm} other {# farms} }",
                    "delete-farms-text": "Be careful, after the confirmation all selected farms will be removed and all related data will become unrecoverable.",
                    "make-public-farm-title": "Are you sure you want to make the farm '{{farmName}}' public?",
                    "make-public-farm-text": "After the confirmation the farm and all its data will be made public and accessible by others.",
                    "make-private-farm-title": "Are you sure you want to make the farm '{{farmName}}' private?",
                    "make-private-farm-text": "After the confirmation the farm and all its data will be made private and won't be accessible by others.",
                    "unassign-farm-title": "Are you sure you want to unassign the farm '{{farmName}}'?",
                    "unassign-farm-text": "After the confirmation the farm will be unassigned and won't be accessible by the customer.",
                    "unassign-farm": "Unassign farm",
                    "unassign-farms-title": "Are you sure you want to unassign { count, select, 1 {1 farm} other {# farms} }?",
                    "unassign-farms-text": "After the confirmation all selected farms will be unassigned and won't be accessible by the customer.",
                    "copyId": "Copy farm Id",
                    "idCopiedMessage": "Farm Id has been copied to clipboard",
                    "select-farm": "Select farm",
                    "no-farms-matching": "No farms matching '{{entity}}' were found.",
                    "orography": "Topographic relief",
                    "pictureAttach": "Attach frontage farm picture",
                    "photographs": "Photographs",
                    "removeCoordinate": "Remove coordinate",
                    "saveFrontageFarmPicture": "Save frontage farm picture",
                    "setLocation": "Locate farm",
                    "technologies": "Technologies",
                    "farm-required": "Farm is required",
                    "uploadPictures": "Upload photos",
                    "name-starts-with": "Farm name starts with",
                    "homeDetails":{
                        "title": "Home Details",
                        "homeMaterial": "Building material",
                        "floorMaterial": "Floor Building material",
                        "rooms": "Number of rooms",
                        "dependingPeople": "Number of people depending of the farm",
                        "workers": "Number of workers",
                        "bathroom": "Bathroom details",
                ...
                "ground":{
                    ...
                    "higrologicData": "Higrologic data"
                },
                "grid": {
                ...
                "landlot": {
                    ...
                    "add": "Add Land lot",
                    "assign-to-customer": "Assign to customer",
                    "assign-landlot-to-customer": "Assign Land lot(s) To Customer",
                    "assign-landlot-to-customer-text": "Please select the land lots to assign to the customer",
                    "no-landlots-text": "No land lots found",
                    "assign-to-customer-text": "Please select the customer to assign the land lot(s)",
                    "public": "Public",
                    "assignedToCustomer": "Assigned to customer",
                    "make-public": "Make land lot public",
                    "make-private": "Make land lot private",
                    "unassign-from-customer": "Unassign from customer",
                    "delete": "Delete land lot",
                    "landlot-public": "Land lot is public",
                    "landlot-type": "Land lot type",
                    "landlot-type-required": "Land lot type is required.",
                    "select-landlot-type": "Select land lot type",
                    "enter-landlot-type": "Enter land lot type",
                    "any-landlot": "Any land lot",
                    "no-landlot-types-matching": "No land lot types matching '{{entitySubtype}}' were found.",
                    "landlot-type-list-empty": "No land lot types selected.",
                    "landlot-types": "Land lot types",
                    "name": "Name",
                    "name-required": "Name is required.",
                    "description": "Description",
                    "type": "Type",
                    ...
                    "assign-landlots-text": "Assign { count, select, 1 {1 landlot} other {# landlots} } to customer",
                    "delete-landlots": "Delete land lots",
                    "unassign-landlots": "Unassign land lots",
                    "unassign-landlots-action-title": "Unassign { count, select, 1 {1 landlot} other {# landlots} } from customer",
                    "assign-new-landlot": "Assign new land lot",
                    "delete-landlot-title": "Are you sure you want to delete the land lot '{{landlotName}}'?",
                    "delete-landlot-text": "Be careful, after the confirmation the land lot and all related data will become unrecoverable.",
                    "delete-landlots-title": "Are you sure you want to delete { count, select, 1 {1 landlot} other {# landlots} }?",
                    "delete-landlots-action-title": "Delete { count, select, 1 {1 landlot} other {# landlots} }",
                    "delete-landlots-text": "Be careful, after the confirmation all selected land lots will be removed and all related data will become unrecoverable.",
                    "make-public-landlot-title": "Are you sure you want to make the land lot '{{landlotName}}' public?",
                    "make-public-landlot-text": "After the confirmation the land lot and all its data will be made public and accessible by others.",
                    "make-private-landlot-title": "Are you sure you want to make the land lot '{{landlotName}}' private?",
                    "make-private-landlot-text": "After the confirmation the land lot and all its data will be made private and won't be accessible by others.",
                    "unassign-landlot-title": "Are you sure you want to unassign the land lot '{{landlotName}}'?",
                    "unassign-landlot-text": "After the confirmation the land lot will be unassigned and won't be accessible by the customer.",
                    "unassign-landlot": "Unassign land lot",
                    "unassign-landlots-title": "Are you sure you want to unassign { count, select, 1 {1 landlot} other {# landlots} }?",
                    "unassign-landlots-text": "After the confirmation all selected land lots will be unassigned and won't be accessible by the customer.",
                    "copyId": "Copy land lot Id",
                    "idCopiedMessage": "Land lot Id has been copied to clipboard",
                    "select-landlot": "Select land lot",
                    "no-landlots-matching": "No land lots matching '{{entity}}' were found.",
                    "landlot-required": "Land lot is required",
                    "name-starts-with": "Land lot name starts with",
                    "totalArea": "Total area",
